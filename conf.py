...
BLOG_EMAIL = "biblioteca@losnavalmorales.es"
# (translatable)
BLOG_DESCRIPTION = "Biblioteca P\u00fablica Municipal de Los Navalmorales"
    ...
    DEFAULT_LANG: (
        (
            (
                ...
                ("/stories/la-biblioteca-de-los-navalmorales/horario", "Horario"),
            ),
            'La Biblioteca'),
        (
            (
                ("http://reddebibliotecas.jccm.es/portal/", "Catálogo JCCM"),
                ("http://www.losnavalmorales.com/mesa/", "Revista Forja"),
                ("http://www.losnavalmorales.es/",
...
TWITTER_CARD = {
    ...
    'card': 'Biblioteca Municipal de Los Navalmorales',
